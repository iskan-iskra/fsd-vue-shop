...
import AppCartActionsButtons from "./CartActions.vue";
import AppCartRemoveButton from "./CartRemove.vue";
...
<template>
  <AppRow align="middle" :lg-gutter="[8, 16]">
    <AppCol :lg="2" :sm="3" :xs="12">
      <img
        v-if="orderProduct?.photo"
        :src="orderProduct?.photo"
        class="order__photo"
      />
      <img v-else src="./product_placeholder.png" class="order__photo" />
    </AppCol>
    <AppCol :lg="1" :sm="3" :xs="4">
    ...
    <AppCol
      ...
      :sm="8"
      :xs="4"
      v-if="orderProduct.warehouseAmount || orderProduct.warehouseAmount === 0"
    >
    ...
    <AppCol :lg="2" :sm="2" :xs="4" class="center">
      <div class="title">Сумма</div>
      <div class="value">
        {{ amountAtCart * orderProduct.cost }}
      </div>
    </AppCol>
    <AppCol :lg="1" :sm="2" :xs="4">
